...
public class Order extends EntityBase<Long> implements IAggregateRoot {
    ...
    private void setPayPrice(BigDecimal payPrice) {
        this.payPrice = payPrice == null ? BigDecimal.ZERO.setScale(2) : payPrice.setScale(2);
    }
    ...
    private void setDiscountPrice(BigDecimal discountPrice) {
